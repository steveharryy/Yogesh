        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {events.map((event, index) => (
              <div key={index} className="bg-white dark:bg-slate-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden border border-gray-200 dark:border-slate-700">
                <img
                  src={event.image}
                  alt={event.title}
                ...
                <div className="p-6">
                  <div className="flex items-center space-x-2 mb-3">
                    ...
                    <span className="text-amber-600 dark:text-amber-400 text-sm font-medium">{event.date}</span>
                  </div>
